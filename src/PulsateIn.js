...
export default class PulsateIn extends Component {
    ...
    render() {
        return (
            <Animated.Image
                style={[styles.image, (this.props.style) && this.props.style, {transform: [{scale: this.scale}]} ]}
